...
ANDRADE, Saimon Gabriel de. **Aplicações governamentais acessíveis**: um estudo de caso com guidelines de acessibilidade e usabilidade para pessoas idosas. 2025. Trabalho de Conclusão de Curso (Bacharelado em Sistemas de Informação) – Universidade Federal de Lavras, Lavras, 2025.

BERNARDO, Lilian Dias. As pessoas idosas e as novas tecnologias: desafios para a construção de soluções que promovam a inclusão digital. **Revista Brasileira de Geriatria e Gerontologia**, Rio de Janeiro, v. 25, n. 4, e230142, 2022.
